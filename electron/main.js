...
ipcMain.on('download', async (event, {payload}) => {
    if (payload.url) {
        ...
        const defaultFileName = properties.fileName ? properties.fileName : payload.url.split('/').pop();
        ...
        if (customURL) {
            ...
            console.log('ipcMain.on(download) directory', directory)
    ...
    //app.webContents.downloadURL(payload.url)
